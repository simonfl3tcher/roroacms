module Roroacms
  ...
  class Admin::MenusController < AdminController
    ...
    add_breadcrumb I18n.t("generic.menus"), :admin_menus, :title => I18n.t("controllers.admin.menus.breadcrumb_title")

    # include the helper in the view
    helper Roroacms::AdminMenuHelper
    ...
    def ajax_dropbox
      print render :partial => 'roroacms/admin/menus/partials/menu_dropdown'
    end
