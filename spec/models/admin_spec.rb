...
describe Admin do 
	...
	it "is invalid with incorrect email address" do 
		...
		FactoryGirl.build(:admin, email: "simon@logicdesign").should_not be_valid

	end

	it "Validates uniqueness of the email address" do

		simon = FactoryGirl.create(:admin, email: "example@example.co.uk")
		keith = FactoryGirl.build(:admin, email: "example@example.co.uk")
